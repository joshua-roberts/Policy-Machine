...
DROP VIEW IF EXISTS `acl_entry_view`;
...
DROP FUNCTION IF EXISTS `add_script`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `allowed_operations`;
DELIMITER //
...
DROP VIEW IF EXISTS `assignment_view`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP TABLE IF EXISTS `audit_information`;
...
DROP PROCEDURE IF EXISTS `create_assignment`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `create_association`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `create_deny`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_node_fun`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `create_object_class`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `create_object_detail`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_ob_cont_spec`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_ob_obj_spec`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_ob_op_spec`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_ob_pc_spec`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_ob_user_spec`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_operand`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_opset`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `create_opset_detail`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_user_detail_fun`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `create_user_fun`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `delete_association`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `delete_deny`;
DELIMITER //
...
DROP TABLE IF EXISTS `deny_operation`;
...
DROP PROCEDURE IF EXISTS `get_ACLs`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_action_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_action_type_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_cond_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_cond_type_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_cont_spec_type_id`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `get_denied_ops`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_deny_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_host_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_host_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `GET_HOST_PATH`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_node_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_node_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_node_type`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_node_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_node_type_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_object_class_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_operand_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_operand_type_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_operation_name`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_op_spec_type_id`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `get_user_spec_type_id`;
DELIMITER //
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='host machine info';
...
DROP FUNCTION IF EXISTS `is_accessible`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `is_ascendant_of`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `is_object_in_deny`;
DELIMITER //
...
-- Dumping data for table pmwsdb.node_property: ~0 rows (approximately)
...
-- Dumping data for table pmwsdb.node_type: ~7 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Object Class';
...
DROP TABLE IF EXISTS `open_object`;
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COMMENT='Operation';

-- Dumping data for table pmwsdb.operation: ~83 rows (approximately)
...
INSERT INTO `operation` (`operation_id`, `operation_type_id`, `name`, `description`, `object_class_id`) VALUES
	...
	(66, 1, 'file write', '2', NULL),
	(67, 1, 'file read', '2', NULL),
	(68, 1, 'assign object attribute', NULL, NULL),
	(69, 1, 'assign object attribute to', NULL, NULL),
	(70, 1, 'assign object', NULL, NULL),
	(71, 1, 'assign object to', NULL, NULL),
	(72, 1, 'create node', NULL, NULL),
	(73, 1, 'delete node', NULL, NULL),
	(74, 1, 'update node', NULL, NULL),
	(75, 1, 'assign to', NULL, NULL),
	(76, 1, 'assign', NULL, NULL),
	(77, 1, 'create object', NULL, NULL),
	(78, 1, 'create object attribute', NULL, NULL),
	(79, 1, 'create user attribute', NULL, NULL),
	(80, 1, 'create user', NULL, NULL),
	(81, 1, 'deassign', NULL, NULL),
	(82, 1, 'deassign from', NULL, NULL),
	(83, 1, 'create association', NULL, NULL),
	(84, 1, 'update association', NULL, NULL),
	(85, 1, 'delete association', NULL, NULL);
/*!40000 ALTER TABLE `operation` ENABLE KEYS */;

-- Dumping structure for table pmwsdb.operation_set_details
DROP TABLE IF EXISTS `operation_set_details`;
...
DROP TABLE IF EXISTS `record_components`;
...
DROP TABLE IF EXISTS `record_key`;
...
DROP PROCEDURE IF EXISTS `set_property`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `update_opset`;
DELIMITER //
