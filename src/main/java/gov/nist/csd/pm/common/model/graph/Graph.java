...
public interface Graph {
     ...
     */
    long createNode(Node node) throws NoIDException, NullTypeException, NullNameException, NullNodeException, DatabaseException, LoadConfigException, InvalidProhibitionSubjectTypeException;
     ...
     */
    void updateNode(Node node) throws NullNodeException, NoIDException, DatabaseException, LoadConfigException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;

    /**
     * Delete the node with the given ID from the graph.
     * @param nodeID the ID of the node to delete.
     */
    void deleteNode(long nodeID) throws DatabaseException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     */
    boolean exists(long nodeID) throws DatabaseException, LoadConfigException, InvalidProhibitionSubjectTypeException;

    /**
     * Retrieve the set of all nodes in the graph.
     * @return A Set of all the nodes in the graph.
     */
    HashSet<Node> getNodes() throws DatabaseException, LoadConfigException, InvalidProhibitionSubjectTypeException;
     ...
     */
    HashSet<Long> getPolicies() throws DatabaseException, LoadConfigException, InvalidProhibitionSubjectTypeException;
     ...
     */
    HashSet<Node> getChildren(long nodeID) throws DatabaseException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     * @return The Set of NGACNodes that are assigned to the node with the given ID.
     */
    HashSet<Node> getParents(long nodeID) throws DatabaseException, LoadConfigException, SessionDoesNotExistException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     */
    void assign(long childID, NodeType childType, long parentID, NodeType parentType) throws DatabaseException, NullNodeException, NullTypeException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidAssignmentException, InvalidProhibitionSubjectTypeException;
     ...
     * @param parentType The type of the parent node.
     */
    void deassign(long childID, NodeType childType, long parentID, NodeType parentType) throws DatabaseException, NullNodeException, NullTypeException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     */
    void associate(long uaID, long targetID, NodeType targetType, HashSet<String> operations) throws DatabaseException, LoadConfigException, MissingPermissionException, SessionDoesNotExistException, NodeNotFoundException, InvalidNodeTypeException, InvalidAssociationException, InvalidProhibitionSubjectTypeException;
     ...
     * @param targetType The type of the target node.
     */
    void dissociate(long uaID, long targetID, NodeType targetType) throws DatabaseException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     */
    HashMap<Long, HashSet<String>> getSourceAssociations(long sourceID) throws DatabaseException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
     ...
     */
    HashMap<Long, HashSet<String>> getTargetAssociations(long targetID) throws DatabaseException, SessionDoesNotExistException, LoadConfigException, MissingPermissionException, NodeNotFoundException, InvalidProhibitionSubjectTypeException;
}
