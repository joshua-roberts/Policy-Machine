...
class GraphServiceIT {
    ...
    void setup() throws PMException, IOException {
        PAP.getPAP();
        superUser = SuperGraph.getSuperU();
    ...
    void TestUpdateNode() throws PMException {
        ...
        assertThrows(PMException.class, () -> service2.updateNode(SuperGraph.getSuperO().getID(), "updated super name", null));
    }
    ...
    void TestDeleteNode() throws PMException {
        ...
        assertThrows(PMException.class, () -> service.deleteNode(SuperGraph.getSuperO().getID()));
   ...
   /* @Test
    ...
    void TestGetPolicies() throws PMException {
        ...
        assertAll(() -> assertTrue(policies.contains(testPC.getID())),
                () -> assertTrue(policies.contains(SuperGraph.getSuperPC().getID())));
    }
    ...
    void TestAssign() throws PMException {
        ...
        service.assign(testO.getID(), SuperGraph.getSuperOA().getID());

        // super assigns super ua2 to test PC
        service.assign(SuperGraph.getSuperUA2().getID(), testPC.getID());

        // test user assigns test o to super oa
        GraphService service1 = new GraphService(testUser.getID(), 0);
        assertThrows(PMException.class,
                () -> service1.assign(testO.getID(), SuperGraph.getSuperOA().getID()));
    }
    ...
    void TestDeassign() throws PMException {
        ...
        GraphService service1 = new GraphService(testUser.getID(), 0);
        assertThrows(PMException.class, () -> service1.deassign(SuperGraph.getSuperO().getID(), SuperGraph.getSuperOA().getID()));
    }
    ...
    void TestAssociate() throws PMException {
        ...
        service.associate(SuperGraph.getSuperUA2().getID(), testOA.getID(), new HashSet<>(Arrays.asList("test")));
        assertTrue(PAP.getPAP().getGraphPAP().getSourceAssociations(SuperGraph.getSuperUA2().getID()).containsKey(testOA.getID()));
        assertTrue(PAP.getPAP().getGraphPAP().getSourceAssociations(SuperGraph.getSuperUA2().getID()).get(testOA.getID()).contains("test"));
        service.associate(SuperGraph.getSuperUA2().getID(), testOA.getID(), new HashSet<>(Arrays.asList("test123")));
        assertTrue(PAP.getPAP().getGraphPAP().getSourceAssociations(SuperGraph.getSuperUA2().getID()).get(testOA.getID()).contains("test123"));

        GraphService service1 = new GraphService(testUser.getID(), 0);
        assertThrows(PMException.class,
                () -> service1.associate(SuperGraph.getSuperUA2().getID(), testOA.getID(), new HashSet<>(Arrays.asList("test"))));
    }
    ...
    void TestDissociate() throws PMException {
        ...
        service.dissociate(SuperGraph.getSuperUA2().getID(), SuperGraph.getSuperOA().getID());
        assertFalse(PAP.getPAP().getGraphPAP()
                        .getSourceAssociations(SuperGraph.getSuperUA2().getID())
                        .containsKey(SuperGraph.getSuperOA().getID()));
    ...
    void TestGetSourceAssociations() throws PMException {
        ...
        Map<Long, Set<String>> assocs = service.getSourceAssociations(SuperGraph.getSuperUA2().getID());
        assertTrue(assocs.containsKey(SuperGraph.getSuperOA().getID()));
        assertTrue(assocs.get(SuperGraph.getSuperOA().getID()).contains("*"));

        GraphService service1 = new GraphService(testUser.getID(), 0);
        assertThrows(PMException.class, () -> service1.getSourceAssociations(SuperGraph.getSuperUA2().getID()));
    ...
    void TestGetTargetAssociations() throws PMException {
        ...
        Map<Long, Set<String>> assocs = service.getTargetAssociations(SuperGraph.getSuperOA().getID());
        assertTrue(assocs.containsKey(SuperGraph.getSuperUA2().getID()));
        assertTrue(assocs.get(SuperGraph.getSuperUA2().getID()).contains("*"));

        GraphService service1 = new GraphService(testUser.getID(), 0);
        assertThrows(PMException.class, () -> service1.getTargetAssociations(SuperGraph.getSuperOA().getID()));
    }
}