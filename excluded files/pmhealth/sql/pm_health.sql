...
INSERT INTO `diagnosis` VALUES (1,1,'Gingivitis and periodonatal disease'),(1,2,'Otis externa'),(1,3,'Food poisoning'),(1,4,'Allergic reaction'),(1,5,'Lower back contusion'),(1,6,'HIV'),(1,7,'Hepatitis B'),(1,8,'Hepatotoxicity'),(2,9,'brain cancer');
...
INSERT INTO `treatment` VALUES (1,1,'Fluids and Antibiotics. Inpatient care.'),(1,2,'Antibiotics'),(1,3,'Stomach pump'),(1,4,'Applied antibiotic ointment'),(1,5,'Ibuprofen and ice'),(1,6,'HIV medication and treatment plan'),(1,7,'Antiviral medication'),(1,8,'Liver transplant. Drug Rehab.'),(2,10,'chemotherapy'),(2,11,'chemotherapy'),(2,12,'chemotherapy');
