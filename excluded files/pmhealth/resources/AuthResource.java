...
import gov.nist.csd.pm.demos.ndac.pmhealth.model.User;
import gov.nist.csd.pm.demos.ndac.pmhealth.requests.LoginRequest;
...
public class AuthResource {
    ...
    @POST
    public Response login(LoginRequest request) throws SQLException, InvalidKeySpecException, NoSuchAlgorithmException, IOException {
        ...
        if(check) {
            ...
            return ApiResponse.Builder.success().entity(sessionId).build();
        }else{
            return ApiResponse.Builder
                    .error(401, "Username or password was not correct")
                    .build();
        }
    }
